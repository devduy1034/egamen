                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 last:!mb-0 md:!mb-0">
                                <label class="form-label" for="regular_price">Gi?:</label>
                                <div class="input-group">
                                    <input type="text" name="data[regular_price]"
                                        class="form-control format-price regular_price" placeholder="Gi?"
                                        aria-label="Gi?" id="regular_price" aria-describedby="regular_price"
                                        value="{{ !empty(Flash::has('regular_price')) ? Flash::get('regular_price') : @$item['regular_price'] }}" />
                                    <span class="input-group-text" id="regular_price">VNữ</span>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="form-group col-md-4 last:!mb-0 md:!mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text" id="sale_price">VNữ</span>
                                </div>
                            </div>
                            @endif
                            @if (!empty($configMan->sale_price))
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="group-properties">
                            ...
                            @component('component.propertiesCard', ['value' => $value, 'key' => $key, 'code' => $code, 'gallery' => $gallery ?? []])
                            @endcomponent
                            @endforeach
                            @endif
                        </div>
